...
class User extends Component{
    ...
    render(){
        ...
        let pageTool=null;
        if(this.state.page){
            pageTool=(<PageTool data={this.state.page}/>);
        }
                        ...
                        <div className="col-sm-10 col-sm-offset-1">
                            ...
                            <div className="btn-group">
                                <button className="btn btn-success btn-sm" type="button">
                                    <i className="ace-icon fa fa-search bigger-110 orange" onClick={this.searchData}></i>查询</button>
                                <button type="button" className="btn btn-success btn-sm">
                                    <i className="ace-icon fa fa-refresh bigger-110 orange"></i>重置</button>
                            </div>
                                    ...
                                    <td>
                                        <div className="btn-group">
                                            ...
                                            <button type="button" className="btn btn-yellow btn-sm" ng-click="vm.deleteItem(x)">
                                                <i className="ace-icon fa fa-trash-o bigger-110 orange"></i>删除</button>
...
export default connect((state)=>{return {state:state.listReduce};})(User);